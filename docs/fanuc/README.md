...
| Area | Pages |
|------|--------|
| Path | [Learning path](learning-path.md), [how to read a guide](how-to-read-a-guide.md), [topic map](topic-map.md) (atom vs union) |
...
| Motion | [Overview](motion-paths-home/overview.md), [jog / recovery](motion-paths-home/jog-and-recovery.md) — path sketches: [OFFSET 1-2-3-4 / 1'-2'-3'-4'](programming-tp/offset-and-incremental.md) |
